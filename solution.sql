...
-- 3. The bank is giving a new customer bonus! Update all records with an account balance of 0.00 and a transactions_attempted of 0. Give them a new account balance of 10.00.
   UPDATE syntax_practice set account_balance='10.0' where account_balance='0' AND transactions_attempted='0';
...
-- 8. Add a new record.
  INSERT INTO	syntax_practice (username, city, transactions_completed, transactions_attempted, account_balance, user_id) VALUES ('barb','minneapolis','100','100','100000','9');
